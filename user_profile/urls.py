...
from .views import (
    UserProfileView, ProfilePicUpdateView, profile_stream_file, ProfilePicDeleteView, OwnerAboutView, CreateChat, ListChat, AddLikeCat, DeleteLikeCat, AddFollowView, 
    DeleteFollowView, UserProfileUpdateView, UserPasswordUpdateView
)
...
urlpatterns = [
    ...
    path('user_chat/<int:pk>', CreateChat.as_view(), name = 'chat'),
    path('user_list_chat/', ListChat.as_view(), name = 'list_chat'),
